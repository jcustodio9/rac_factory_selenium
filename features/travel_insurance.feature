...
@travel_insurance_quote
Scenario Outline: Get a quote for a travel insurance for 2pax with 1 child, resident & non-member
...
And I select number of accompanied children: <children> <child_age>
...
Examples:
| destination 	| country 		| departure_date 	| departure_month 	| departure_year 	| return_date 	| return_month 	| return_year 	| traveller_1 	| traveller_2 	| children 	| child_age	| resident 	| membership 	| pre_existing 	|
| Asia 			| Philippines 	| 17 				| December 			| 2015 				| 9 			| January 		| 2016 			| 32 			| 31 			| 1 		| 2 		| Yes 		| No 			| No 			|
